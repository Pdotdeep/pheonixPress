...
class TestExtract
{
	...
	public function test_extract($parent)
	{
		...
		{
			Factory::getLog()->warning(Text::_('COM_AKEEBA_ENGINE_TEXTEXTRACT_ERR_PROCESSIMMEDIATELY'));
		...
		{
			Factory::getLog()->warning(Text::_('COM_AKEEBA_ENGINE_TEXTEXTRACT_ERR_INVALIDARCHIVERTYPE'));
		...
		if ($ret['Error'] != '')
		{
			throw new RuntimeException(Text::sprintf('COM_AKEEBA_ENGINE_TEXTEXTRACT_ERR_INTEGRITYCHECKFAILED', $ret['Error']));
		}
