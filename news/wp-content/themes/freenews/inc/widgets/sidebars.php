...
function freenews_widgets_init() {
	...
	register_sidebar( array(
        ...
        register_sidebar( array(
		'name'          => esc_html__( 'FreeNews Template Footer Section', 'freenews' ),
		'id'            => 'freenews-template-footer',
		'description'   => esc_html__( 'This section will appear when FreeNews Template is selected at Footer Section', 'freenews' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
